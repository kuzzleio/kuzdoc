...
kuzdoc/2.4.3 darwin-x64 node-v12.18.3
$ kuzdoc --help [COMMAND]
USAGE
  $ kuzdoc COMMAND
...
...
_See code: [src/commands/add-repo.ts](https://github.com/kuzzleio/kuzdoc/blob/v2.4.3/src/commands/add-repo.ts)_
...
_See code: [src/commands/add-section.ts](https://github.com/kuzzleio/kuzdoc/blob/v2.4.3/src/commands/add-section.ts)_
...
_See code: [src/commands/build-and-deploy.ts](https://github.com/kuzzleio/kuzdoc/blob/v2.4.3/src/commands/build-and-deploy.ts)_
...
_See code: [src/commands/dead-links.ts](https://github.com/kuzzleio/kuzdoc/blob/v2.4.3/src/commands/dead-links.ts)_
...
_See code: [src/commands/dev.ts](https://github.com/kuzzleio/kuzdoc/blob/v2.4.3/src/commands/dev.ts)_
...
_See code: [src/commands/install.ts](https://github.com/kuzzleio/kuzdoc/blob/v2.4.3/src/commands/install.ts)_
...
_See code: [src/commands/local-deploy.ts](https://github.com/kuzzleio/kuzdoc/blob/v2.4.3/src/commands/local-deploy.ts)_
<!-- commandsstop -->
